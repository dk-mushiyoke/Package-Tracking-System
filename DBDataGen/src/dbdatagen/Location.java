...
public class Location {
    public static final int COUNT = 75, IDDIGIT = 4;
    public static void locationGen() {
        ...
        for(int i = 0; i < COUNT; i++) {
            ...
            System.out.printf("insert into location values(%d,'%s','%s','%s','%s',%d,'%s');\n",id,type,street,city,state,zip,country);
        }
    }
